...
export default function PlayerInfo(props: any) {  
    const getAge = () =>
    {
        let birthYear = new Date().getFullYear() - (props?.player.birthDate.split("-")[0])
        return birthYear;
    }
        ...
        <div className="container col-12 p-0" style={{border: '1px solid gray', borderRadius: '6px'}}>
            ...
            <div className="container row m-0">
                <div className="container col-6">
                    ...
                    <h6><b>Birth Date: </b>{props?.player.birthDate} <span className="text-secondary">({`${getAge()} years old`})</span></h6>
